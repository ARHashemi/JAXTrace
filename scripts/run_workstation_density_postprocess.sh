...
BANDWIDTH=""
# h = BANDWIDTH_FACTOR * max(voxel_spacing). With wendland_c2 support 2h,
# the kernel reach is 2*BANDWIDTH_FACTOR voxels along the coarsest axis.
# Increase on anisotropic grids so the kernel spans multiple voxels in
# every direction.
