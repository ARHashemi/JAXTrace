#!/usr/bin/env python3
"""
Test mesh-aligned Morton with MULTI-CELL assignment (bbox-based).

This is the CORRECT implementation:
- Each element assigned to ALL cells its bbox intersects
- Expected retention: 96-98%+ (same as original element-based Morton)
"""
...
from jaxtrace.gpu.search.mesh_aligned_octree_multi_cell import extract_octree_cells_multi
...
print("=" * 80)
print(f"Mesh-Aligned Morton - MULTI-CELL Assignment (Bbox-Based)")
...
# Extract cells with MULTI-CELL assignment
print("\n[3/7] Extracting octree cells (multi-cell assignment)...")
mesh_octree_cells = extract_octree_cells_multi(
...
print(f"\n{'='*80}")
print(f"RESULTS - MULTI-CELL ASSIGNMENT")
print(f"{'='*80}")
...
print(f"\n{'='*80}")
print(f"✅ Multi-cell assignment test complete!")
print(f"{'='*80}\n")
